            ...
            <div key={review.id} class="w-full">
              <div class="flex justify-start items-start flex-col bg-gray-50 dark:bg-gray-800 p-8 w-full">
                <div id="menu" class="w-full">
                  <p className="lg:text-2xl font-black leading-9 text-blue-800 dark:text-white mb-3 mt-3">
                    {review.item}
                  </p>
                  ...
                  <p className="lg:text-2xl font-black leading-9 text-gray-800 dark:text-white mb-3 mt-3">
                    {review.title}
                  </p>
                  <p class="mt-3 text-base leading-normal text-gray-600 dark:text-white">
                    {review.content}
                  </p>
                  ...
                  <div class="mt-6 flex justify-start items-center flex-row space-x-2.5">
                    ...
                    <div class="flex flex-col justify-start items-start space-y-2">
                      ...
                      <p class="text-sm leading-none text-gray-600 dark:text-white">
                        {formatDate(reviewList[0].createdDate)}
                      </p>
                    </div>
                  </div>
